...
export class CreateCourseProblemSettingsTable1768268156726 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "steps_db"."course_problem_settings"`);
    await queryRunner.query(
      `CREATE INDEX "IDX_8d2e5f9dcc8db56615489ffe37" ON "steps_db"."problem_tag" ("tagId") `,
    );
    await queryRunner.query(
