...
export class AlterProblemTagAndSettingsConstraints1768501537027 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" DROP CONSTRAINT "PK_f18187b9f70cafb73efe8c980ba"`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" ADD CONSTRAINT "PK_055035df51a19809d0485074376" PRIMARY KEY ("problemId", "tagId", "id")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" DROP CONSTRAINT "PK_055035df51a19809d0485074376"`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" ADD CONSTRAINT "PK_5ff52344c1512891dc04da9b11e" PRIMARY KEY ("tagId", "id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" DROP CONSTRAINT "PK_5ff52344c1512891dc04da9b11e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" ADD CONSTRAINT "PK_616dce8d47dfbb445de4691ed1d" PRIMARY KEY ("id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."course_problem_settings" DROP CONSTRAINT "REL_e29f8cf1d441181cda6fd9559e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."course_problem_settings" DROP CONSTRAINT "REL_a6021ee7b2131e024405507dfe"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "steps_db"."course_problem_settings" ADD CONSTRAINT "REL_a6021ee7b2131e024405507dfe" UNIQUE ("problemId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."course_problem_settings" ADD CONSTRAINT "REL_e29f8cf1d441181cda6fd9559e" UNIQUE ("courseId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" DROP CONSTRAINT "PK_616dce8d47dfbb445de4691ed1d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" ADD CONSTRAINT "PK_5ff52344c1512891dc04da9b11e" PRIMARY KEY ("tagId", "id")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" ADD CONSTRAINT "PK_f18187b9f70cafb73efe8c980ba" PRIMARY KEY ("problemId", "tagId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps_db"."problem_tag" DROP COLUMN "id"`,
    );
    await queryRunner.query(
